		...
		<div class="row justify-content-center">
			<div class="col-lg-12">
				<div class="search-bar text-center">
					<h3 style="font-weight: bold;" class="py-4">Borrowed Books</h3>
				</div>
										...
										?>
											<li class="list-group-item my-2">
												<div class="d-flex align-items-center w-100 justify-content-between">
													...
													<a href="process_bDel.php?r_id=<?php echo $row['req_id'] ?>" class="col-auto btn btn-sm btn-danger delete-btn">Delete</a>
													</div>
												</div>
											</li>
										<?php
