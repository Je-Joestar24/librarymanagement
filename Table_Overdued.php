            ...
            <main>
                <div class="card border-0 bg-transparent text-white rounded-1 mt-lg-5 rounded-4 p-4">
                    <div class="card-header bg-transparent py-4">
                        <h2 class=" mb-5 d-grid row card-title px-4">Overdued</h2>
                    </div>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover bg-light border-0" id="BorrowerTable">
                            ...
                            <tbody>
                                ...
                                INNER JOIN courses c ON c.course_id = uc.course_id WHERE br.duedate < br.return_date || (br.duedate < now() && br.return_date is null)  GROUP BY br.borrowing_id;";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="clickable-row text-center" data-bs-toggle="modal" data-bs-target="#userInfoModal" data-user-name="<?php echo $row['first_name'] . ' ' . $row['last_name'] ?>" data-course-year="<?php echo $row['course_name'] . ' - ' . $row['year'] ?>" data-email="<?php echo $row['email'] ?>" data-borrowed-books="<?php echo $row['books'] ?>"><?php
                                                                                                                                                                                                                                                                                                                                                                                            if ($row['return_date'] ==  null) echo "<div class = 'text-white bg-danger rounded-5'>Not returned</div>";
